...
*  @version 1.0
*  @package OrganizationGroupController AngularJS module  
*/

var app = angular.module('OrganizationGroupController', ['theme.core.services', 'GroupDetails']);     //instantiates GroupsController module
app.controller('organizationGroupController', function ($scope, $theme, $location, $rootScope, stateService, apiService, groupDetails) {
	'use strict';
